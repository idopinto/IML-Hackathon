...
if __name__ == '__main__':
    ...
    # Task 1
    test_df1 = utils.load_data("hackathon_code/Datasets/Agoda_Test_1.csv", cancel=False)
    ...
    # ------------------------------------------------------------
    # task 2
    test_df2 = utils.load_data("hackathon_code/Datasets/Agoda_Test_2.csv", cancel=False)
